...
const WidgetBar = ({ onToggle }: WidgetBarProps): JSX.Element => {
	const hasRooms = rooms.value.length > 0

	return (
		<div className="pointer-events-auto absolute left-1/2 top-4 flex -translate-x-1/2 gap-1.5 rounded-lg border border-gray-800/50 bg-gray-950/90 px-2 py-1 shadow-2xl backdrop-blur-md">
			<button
